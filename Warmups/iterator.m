...
% I CHANGED THE NUMBER OF ROWS TO 8
...
for I = 2: N_steps	
	...
	for J = 1:8
		% Update position
		position(J,1,I) = position(J,1,I-1) + velocity(J,1,I-1)*dt;
		position(J,2,I) = position(J,2,I-1) + velocity(J,2,I-1)*dt;

		% Update velocity
		velocity(J,1,I) = velocity(J,1,I-1) + acceleration(J,1,I-1)*dt;
		velocity(J,2,I) = velocity(J,2,I-1) + acceleration(J,2,I-1)*dt;
	end 
